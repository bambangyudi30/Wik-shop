                ...
                <table class="table table-bordered data-table">
                    ...
                    @foreach($products as $product)
                        ...
                        <tr class="gradeC">
                            ...
                            <td style="vertical-align: middle;text-align: center;"><a href="{{route('product_attr.show',$product->id)}}" class="btn btn-success btn-mini">Tambah Att</a></td>
...
@section('jsblock')
    ...
    <script>
        $(".deleteRecord").click(function () {
            ...
            swal({
                title:'Apakah benar Ingin menghapus?',
                text:"Tidak Bisa di Kembalikan lagi!",
                type:'warning',
