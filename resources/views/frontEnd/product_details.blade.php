...
@section('content')
    <div class="container">
            ...
            <div class="col-sm-7">
                <form action="{{route('addToCart')}}" method="post" role="form">
                    ...
                    <div class="product-information"><!--/product-information-->
                        ...
                        <p><b>Ketersediaan Barang:</b>
                            @if($totalStock>0)
                                <span id="availableStock">Stok ada</span>
                            @else
        ...
        <div class="recommended_items"><!--recommended_items-->
            <h2 class="title text-center">recommended Produk</h2>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <h2>{{$item->price}}</h2>
                                                <p>{{$item->p_name}}</p>
                                                <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Masukan Dalam Keranjang</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
